...
Bienvenido/a a mi perfil. Aquí comparto proyectos personales y de aprendizaje relacionados con desarrollo web, móvil y análisis de datos.

## Perfil
- 💻 Enfoque: desarrollo web, Android y proyectos con datos
- 🧩 Lenguajes: Java, JavaScript, PHP, C#
- 📚 Explorando: nuevas herramientas y mejores prácticas de desarrollo
